...
export const GetQr = () => {
    ...
    const handleQr = async () => {
        try {
            ...
            if (response.status === 200) {
                const imageUrl = `data:image/png;base64,${responseData.qr_code_path}`;
                setQr({ imageUrl });
                setError(null);
            } else if (response.status === 404) {
                setQr({ imageUrl: "" });
                setError("Link not found. Please shorten your link first.");
            } else {
    ...
    return (
        <Box>
            <Box maxWidth="xl" sx={{ display: "flex", alignItems: "center", justifyContent: "center" }} className="text-white my-14 main_container">
                <Grid maxWidth="md">
                            ...
                            <Box maxWidth="xl" className="mx-auto mt-4 mb-6 w-full">
                                <Grid maxWidth="xl">
                                    <Grid>
                                        ...
                                        >
                                            Enter your shortened link to fetch the assigned QR code.
                                                ...
                                                <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                                                    <Box className="flex items-center gap-2 mx-auto">
                                                        <input
                                                            ...
                                                            placeholder="Enter Your Shortened Link Here"
                                                        />
                                                        <Button
