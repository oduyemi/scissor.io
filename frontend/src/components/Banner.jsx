    ...
    return(
        <>
            <Box className="banner  mt-5 w-full md-1/3 px-7 mx-auto relative flex items-stretch justify-between">
                <Box maxWidth="md" className="banner-head w-full md-2/3 p-3 ml-6">
                    <Typography variant="h1" sx={{ fontWeight: "bold", textTransform: "capitalize" }} className="topic pl-4 mt-0 text-white text-5xl gap">
                        Make every
                        <span>
                            <Typography variant="h1" sx={{ color: "#DE89BE", fontWeight: "bold" }} className="topic gap">
                                connection
                    ...
                    <Box maxWidth="sm" className="pl-6 gap">
                ...
                <Box className="banner-image  embed-responsive-item w-full flex items-center justify-center mx-auto p-3 mr-10">
